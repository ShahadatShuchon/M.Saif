...
df = pd.read_excel(r'C:\Users\Shahadat Shuchon\Documents\data luzerne\data_luzerne_rev.xlsx')
df.head()
...
data1.to_excel("data_luzerne_JIRA_ID_stem_count_descriptive_statistics.xlsx")
...
df3.to_excel("data_luzerne_JIRA_ID_descriptive_analysis_farm_name_adviser.xlsx")
...
data2.to_excel("data_luzerne_No_champ_stem_count_descriptive_statistics.xlsx")
...
df6.to_excel("data_luzerne_Field_name_descriptive_statistics_farm_name_adviser.xlsx")
...
dff2.to_excel("data_luzerne_JIRA_ID_Fall_season_descriptive_analysis.xlsx")
...
dfs2.to_excel("data_luzerne_JIRA_ID_Spring_season_descriptive_analysis.xlsx")
...
df_2.to_excel("data_luzerne_Field_name_Fall_season_descriptive_analysis.xlsx")
...
df_3.to_excel("data_luzerne_Field_name_Spring_season_descriptive_analysis.xlsx")
...
plt.show()
plt.draw()
fig1.savefig('province_Nouvelle-Écosse_stem_count.jpg', dpi= 500)
...
plt.figure(figsize=(8,6))
plt.hist(data1, bins=100, color = "steelblue", alpha=1.0, label="Total")
plt.hist(data3, bins=10, color = "aquamarine", alpha=1.0, label="Nouvelle-Écosse")
#plt.hist(data3, bins=100, alpha=0.5, label="Potassium (K)")
x = 10
y = 90
plt.axvline(x, color='k', linestyle='dashed', linewidth=1)
...
plt.show()
plt.draw()
fig1.savefig("Total_Nouvelle-Écosse_Overlapping_histogram.jpg", dpi= 500)
...
plt.hist(data3, bins=10, color = "aquamarine", alpha=1, label="Nouvelle-Écosse")
